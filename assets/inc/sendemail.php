...
require '../vendors/smtpmail/librarysmtp/autoload.php';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $mail->Username   = 'care.tigalintangsuminar@gmail.com';                     //SMTP username
        $mail->Password   = 'xznzlrkkwbmfkfnp';                               //SMTP password
        $mail->SMTPSecure = 'tls';            //Enable implicit TLS encryption
        $mail->Port       = 587;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`
    
        //Recipients
        $mail->setFrom($email, $name);
        $mail->addAddress('care.tigalintangsuminar@gmail.com');     //email tujuan
        ...
        $mail->Body    = 'phone number :+62 '. + $phone . '<br><br> Message : <br>' . $message;
        $mail->AltBody = '';
